...
def moneyTransactionManagement(userid, totalamt, myorderitemsid, demandedQuantity, selleridarray, price, availableQuantity,orderid, discount_percentage, coupon_id):
    try:
    ...
    query = f"UPDATE orders SET userid = {userid}, orderdate = '{current_timestamp}', totalamt = {totalamt}, shippingaddressid = 1 , paymentmethodid = {paymentmethodid}, couponid = {coupon_id} WHERE orderid = {orderid};"
